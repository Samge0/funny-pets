...
const EN = {
  ...
  // v12 涂色槽位名（paint.js PAINT_SLOTS.label 走 t()）
  '身体': 'Body', '肚皮': 'Belly', '点缀': 'Accent', '属性': 'Type',
  // v12 paint tab + v13.1 battle fx toggle（i18n 补全）
  '🎨 涂色': '🎨 Paint',
  '预览实时生效，点「保存」才写入存档': 'Preview is live — nothing saves until you press Save',
  '恢复默认色': 'Restore default color',
  '头顶色': 'Top color',
  '底部色': 'Bottom color',
  '描述色彩方案，如「樱花粉渐变到白色」': 'Describe a color scheme, e.g. "cherry pink fading to white"',
  '需在设置页启用 AI': 'Enable AI in Settings first',
  'AI 一键涂色': 'AI Auto-Paint',
  '🎨…': '🎨…',
  '还原': 'Revert',
  '清除全部涂色': 'Clear all colors',
  '清除 {name} 的全部自定义涂色？（恢复默认配色）': 'Clear all custom colors of {name}? (restores defaults)',
  '保存涂色': 'Save colors',
  '涂色已保存！': 'Colors saved!',
  '保存失败，请稍后再试': 'Save failed — try again later',
  '已恢复默认配色': 'Restored default colors',
  'AI 配色已应用，满意就点保存吧！': 'AI colors applied — press Save if you like them!',
  'AI 涂色失败：{err}': 'AI paint failed: {err}',
  '有未保存的涂色，确定丢弃并关闭吗？': 'Unsaved color changes — discard and close?',
  '⚔️ 战斗': '⚔️ Battle',
  '技能特效（粒子/冲击环/全屏闪光/震屏）。关闭后仅保留基础受击反馈，战斗更省电。': 'Skill effects (particles, shockwaves, fullscreen flashes, screen shake). Turning them off keeps basic hit feedback and saves battery.',
  '战斗特效': 'Battle effects',
  '开': 'On',
  '关': 'Off',
  '战斗特效已开启': 'Battle effects on',
  '战斗特效已关闭': 'Battle effects off',
...
const JA = {
  ...
  // v12 塗色スロット名
  '身体': 'ボディ', '肚皮': 'おなか', '点缀': 'アクセント', '属性': 'タイプ',
  // v12 涂色 + v13.1 特效开关（i18n 補完）
  '🎨 涂色': '🎨 塗色',
  '预览实时生效，点「保存」才写入存档': 'プレビューは即時反映。「保存」でセーブされます',
  '恢复默认色': 'デフォルト色に戻す',
  '头顶色': '上の色',
  '底部色': '下の色',
  '描述色彩方案，如「樱花粉渐变到白色」': '配色を入力（例：桜ピンクから白へのグラデーション）',
  '需在设置页启用 AI': '設定で AI を有効にしてください',
  'AI 一键涂色': 'AI 自動塗色',
  '还原': '元に戻す',
  '清除全部涂色': '全塗色をクリア',
  '清除 {name} 的全部自定义涂色？（恢复默认配色）': '{name} の全カスタム配色をクリアしますか？（デフォルトに戻す）',
  '保存涂色': '配色を保存',
  '涂色已保存！': '配色を保存しました！',
  '保存失败，请稍后再试': '保存に失敗しました。後でもう一度',
  '已恢复默认配色': 'デフォルト配色に戻しました',
  'AI 配色已应用，满意就点保存吧！': 'AI 配色を適用しました。良ければ保存してください！',
  'AI 涂色失败：{err}': 'AI 塗色に失敗：{err}',
  '有未保存的涂色，确定丢弃并关闭吗？': '未保存の塗色があります。破棄して閉じますか？',
  '⚔️ 战斗': '⚔️ バトル',
  '技能特效（粒子/冲击环/全屏闪光/震屏）。关闭后仅保留基础受击反馈，战斗更省电。': 'スキルエフェクト（粒子・衝撃波・全画面フラッシュ・画面シェイク）。オフでも基本のヒット反応は残り、省電力になります。',
  '战斗特效': 'バトルエフェクト',
  '开': 'ON',
  '关': 'OFF',
  '战斗特效已开启': 'バトルエフェクト ON',
  '战斗特效已关闭': 'バトルエフェクト OFF',
  '启用 AI 生成': 'AI 生成を有効化',
  '💾 存档': '💾 セーブデータ',
...
const ZH_TW = {
  ...
  // v12 塗色槽位名
  '身体': '身體', '肚皮': '肚子', '点缀': '點綴', '属性': '屬性',
  // v12 塗色 + v13.1 特效開關（i18n 補完）
  '🎨 涂色': '🎨 塗色',
  '预览实时生效，点「保存」才写入存档': '預覽即時生效，按「儲存」才寫入存檔',
  '恢复默认色': '恢復預設色',
  '头顶色': '頭頂色',
  '底部色': '底部色',
  '描述色彩方案，如「樱花粉渐变到白色」': '描述配色方案，如「櫻花粉漸變到白色」',
  '需在设置页启用 AI': '需在設定頁啟用 AI',
  'AI 一键涂色': 'AI 一鍵塗色',
  '还原': '還原',
  '清除全部涂色': '清除全部塗色',
  '清除 {name} 的全部自定义涂色？（恢复默认配色）': '清除 {name} 的全部自訂塗色？（恢復預設配色）',
  '保存涂色': '儲存塗色',
  '涂色已保存！': '塗色已儲存！',
  '保存失败，请稍后再试': '儲存失敗，請稍後再試',
  '已恢复默认配色': '已恢復預設配色',
  'AI 配色已应用，满意就点保存吧！': 'AI 配色已套用，滿意就按儲存吧！',
  'AI 涂色失败：{err}': 'AI 塗色失敗：{err}',
  '有未保存的涂色，确定丢弃并关闭吗？': '有未儲存的塗色，確定丟棄並關閉嗎？',
  '⚔️ 战斗': '⚔️ 戰鬥',
  '技能特效（粒子/冲击环/全屏闪光/震屏）。关闭后仅保留基础受击反馈，战斗更省电。': '技能特效（粒子/衝擊環/全螢幕閃光/震屏）。關閉後僅保留基礎受擊回饋，戰鬥更省電。',
  '战斗特效': '戰鬥特效',
  '开': '開',
  '关': '關',
  '战斗特效已开启': '戰鬥特效已開啟',
